...
- Public GitHub: github.com/gusok2015.
...
- VocacioNext Bot: a vocational guidance bot based on the RIASEC model built with React 18, TypeScript, Vite, Recharts, Node.js, and Telegraf.
- Enterprise AI: an AI Gateway & Router featuring PII security, smart routing, financial AI metrics, Python 3.11, Uvicorn, Llama 3.3 70B, Llama 3.1 8B, Gemma 2, and Chart.js.
- SaludMental: a tech analytics project focusing on mental health in the tech industry.
- Enterprise QA: a testing suite and telemetry dashboard built with Python, Pytest, Selenium 4, POM, and Chrome Headless.
...
7. Avoid claiming to take real-world actions or speak for Gustavo beyond this portfolio.
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Gustavo Rojas 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/mypic.jpeg" alt="Gustavo" loading="lazy" decoding="async" />
              </div>
              <div className="player-details">
                <span className="player-name">Gustavo</span>
